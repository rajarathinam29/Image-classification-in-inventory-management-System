                ...
                <div class="table-responsive">
                    <table class="table table-bordered mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td class="">
                                    <span class="font-weight-semibold w-50">Suppliers</span>
                                </td>
                                <td id="supplier"></td>
                            </tr>
                            <tr>
    ...
    <div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="purchasepaymentTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
							...
							<tbody id="purchasepaymentContent">
...
<script src="<?php echo e(asset('assets/js/purchase/purchasePaymentview.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/purchasepayment/view.blade.php ENDPATH**/ ?>