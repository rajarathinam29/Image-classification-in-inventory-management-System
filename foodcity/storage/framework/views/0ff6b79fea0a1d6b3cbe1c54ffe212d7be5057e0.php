        ...
        <div class="card">
            <form id="chequeForm">
                ...
                <div class="card-footer text-end">
                    ...
                    <button type="button" class="btn  btn-success" id="btnSubmit">Update <i class="fe fe-skip-forward"></i></button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo e(asset('assets/js/cheque/received/edit.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/cheque/received/edit.blade.php ENDPATH**/ ?>