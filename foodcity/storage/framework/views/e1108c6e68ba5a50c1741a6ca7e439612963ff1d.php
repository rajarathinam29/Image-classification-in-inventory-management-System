		...
		<!-- Show Password -->
		<script src="<?php echo e(asset('assets/plugins/bootstrap-show-password/bootstrap-show-password.min.js')); ?>"></script>
		...
		<!-- Custom js-->
		<script src="<?php echo e(asset('assets/js/custom.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/layouts/custom-scripts.blade.php ENDPATH**/ ?>