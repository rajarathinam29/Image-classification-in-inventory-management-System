	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('superAdminAdmins.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-user-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="userTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
...
<script src="<?php echo e(asset('assets/superadmin/js/admins/users.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/superadmin/admins/users-list.blade.php ENDPATH**/ ?>