			...
			<div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered mb-0">
                        ...
                        <tr>
                                <td class="">
                                    <span class="font-weight-semibold w-50">Manufacture Name</span>
                                </td>
...
<script src="<?php echo e(asset('assets/js/productcompanies/view.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/productcompanies/view.blade.php ENDPATH**/ ?>