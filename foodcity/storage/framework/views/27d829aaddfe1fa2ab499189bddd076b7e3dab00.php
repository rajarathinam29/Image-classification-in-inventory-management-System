	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('productcategories.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="categoriesTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
									<!-- <th class="border-bottom-0">User id</th> -->
									<th class="border-bottom-0">#</th>
									<th class="border-bottom-0">Categories</th>
                                    <th class="border-bottom-0">Descripton</th>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" href=""><i class="fe fe-list me-2"></i> List of all categories</a>
												<a class="dropdown-item" href=""><i class="fe fe-plus-circle me-2"></i> Add category</a>
											</div>
										</div>
									</td>
									<td>
...
<script src="<?php echo e(asset('assets/js/productcategories/productcategories.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/productcategories/category-list.blade.php ENDPATH**/ ?>