	...
	<div class="col-12">
						...
						<div class="col-lg-3 col-md-6">
							<div class="form-group">
								...
								<select class="form-control custom-select select2" name="sltStatus" id="sltStatus">
									...
									<option value="2">Received & Paid</option>
								</select>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
		...
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('partsReceive.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="partsReceiveTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
...
<script src="<?php echo e(asset('assets/js/wip-parts-receive/partsReceive.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/wip-parts-receive/parts-receive-list.blade.php ENDPATH**/ ?>