								...
								<div class="card">
									<div class="card-header">
										...
										<div class="card-options">
											<a href="<?php echo e(url('uploads/import/customers.xlsx')); ?>" class="btn btn-sm btn-success" target="_blank"><i class="fe fe-download me-2"></i> Download Templete File</a>
										</div>
									</div>
									<div class="card-body">
...
<script src="<?php echo e(asset('assets/js/settings/imports/importCustomers.js?v=1.0.1')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/settings/imports/customers.blade.php ENDPATH**/ ?>