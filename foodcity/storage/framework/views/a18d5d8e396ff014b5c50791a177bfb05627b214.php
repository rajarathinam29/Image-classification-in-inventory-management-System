	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('stockcount.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="stockcountTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
									...
									<th class="border-bottom-0">CreatedBy</th>
									<th class="border-bottom-0">Actions</th>
								</tr>
							</thead>
							<tbody id="stockcountContent"></tbody>
						</table>
					</div>
				</div>
			</div>
...
<script src="<?php echo e(asset('assets/js/stockcount/stockcount.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/stockcount/stockcount-list.blade.php ENDPATH**/ ?>