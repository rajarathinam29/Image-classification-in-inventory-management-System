		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title" id="profitTitle"><?php echo e($title); ?></h3>
				</div>
				<div class="card-body">
...
<script src="<?php echo e(asset('assets/js/reports/productProfit.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/reports/profit-report.blade.php ENDPATH**/ ?>