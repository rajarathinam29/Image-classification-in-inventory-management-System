				...
				<ul class="timelineleft pb-5" id="timelineContent">
					...
					<li>
						...
						<div class="timelineleft-item">
							...
							<div class="timelineleft-body">
								<img src="<?php echo e(asset('assets/images/photos/5.jpg')); ?>" alt="..." class="margin mt-2 mb-2">
								<img src="<?php echo e(asset('assets/images/photos/7.jpg')); ?>" alt="..." class="margin mt-2 mb-2 ">
							</div>
						</div>
					</li>
					<li>
					...
					<li>
						...
						<div class="timelineleft-item">
							...
							<h3 class="timelineleft-header"><a href="javascript:void(0);">Mina Lee</a> uploaded new photos</h3>
							<div class="timelineleft-body">
								<img src="<?php echo e(asset('assets/images/photos/1.jpg')); ?>" alt="..." class="margin mt-2 mb-2">
								<img src="<?php echo e(asset('assets/images/photos/2.jpg')); ?>" alt="..." class="margin mt-2 mb-2 ">
								<img src="<?php echo e(asset('assets/images/photos/3.jpg')); ?>" alt="..." class="margin mt-2 mb-2 ">
								<img src="<?php echo e(asset('assets/images/photos/4.jpg')); ?>" alt="..." class="margin mt-2 mb-2">
							</div>
						</div>
					</li>
					<li>
...
<script src="<?php echo e(asset('assets/js/activityLogs/activityLogs.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/activity/activity-list.blade.php ENDPATH**/ ?>