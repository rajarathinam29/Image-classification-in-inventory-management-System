            ...
            <form id="purchaseOrderForm">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Order Id<span class="text-red">*</span></label>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Order Type<span class="text-red">*</span></label>
                                <select class="form-control custom-select select2" name="orderType" id="orderType">
                                    <option value="0">Normal Order</option>
                                    <option value="1">Wip Order</option>
                                </select>
                            </div>
                        </div>
						<div class="col-lg-4 col-md-6" style="display:none;">
                            <div class="form-group">
                                <label class="form-label">WIP Id<span class="text-red">*</span></label>
                                <select class="form-control custom-select select2" name="wipId" id="wipId">
                        ...
                        <!-- <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="total_amount" id="total_amount" step="any" placeholder="Total Amount" autocomplete="off">  
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Discount</label>
                                <input type="number" class="form-control" name="discount" id="discount" step="any" placeholder="Discount" autocomplete="off">  
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Additional Cost</label>
                                <input type="number" class="form-control" name="cost" id="cost" step="any" placeholder="Cost" autocomplete="off">  
                            </div> 
                        </div>-->
                    </div>
                </div>
...
<script src="<?php echo e(asset('assets/js/purchase/purchaseOrderCreate.js?v=1.0.1')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/purchase/purchase-order-create.blade.php ENDPATH**/ ?>