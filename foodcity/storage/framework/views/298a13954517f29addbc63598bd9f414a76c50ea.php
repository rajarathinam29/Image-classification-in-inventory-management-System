...
<div class="page-header">
    ...
    <div class="page-rightheader">
        <div class="btn-list">
            ...
            <!-- <a href="<?php echo e(route('products.create')); ?>" class="btn btn-success"><i class="fe fe-plus"></i> New Product</a> -->
...
<script src="<?php echo e(asset('assets/js/purchase/view.js?v=1.0.0')); ?>"></script>

<!-- INTERNAL tooltip js-->
<!-- <script src="<?php echo e(asset('assets/js/tooltip.js')); ?>"></script> -->

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/purchase/view.blade.php ENDPATH**/ ?>