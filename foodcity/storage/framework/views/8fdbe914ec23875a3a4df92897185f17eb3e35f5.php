...
<div class="row">
    <div class="col-md-12">
        <div class="card overflow-hidden" >
            <div class="card-body">
                <h2 class="font-weight-bold text-primary" id="receiveId">Order Form</h2>
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="mb-1" id="receiveDate">2023-01-01</h5>
                        <h6 class="mb-1" id="orderId">2023-01-01</h6>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group row">
                            <label class="form-label col-md-3">Invoice No.</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="invoiceNo" id="invoiceNo" placeholder="Invoice No"  autocomplete="off">
                            </div>
                    ...
                    <table class="table table-bordered table-hover text-nowrap">
                        <tbody>
                            <tr class=" ">
                                ...
                                <th class="text-center" >Receive Note</th>
                                <th class="text-center" >Receive Date</th>
                                <th class="text-center" >Expiry</th>
                                <th class="text-end" >Pur. Price</th>
                                
                                <th class="text-end">Total</th>
                                <th class="text-end" style="width: 15px;">Actions</th>
                            </tr>
                            <!-- <tr id="trAddProduct">
                                ...
                                <td class="text-center" id="ordered_unit"></td>
                                ...
                                <td class="text-center">
                                    <input type="text" class="form-control form-control-sm" name="note" id="note" placeholder="Note" autocomplete="off">
                                </td>
                                <td class="text-center">
                        ...
                        <tbody id="purchaseOrderContent"></tbody>
                        <tbody id="productContent"></tbody>
                        <tfoot>
                            <tr>
                                <td colspan="8" class="font-weight-semibold text-end">Subtotal</td>
                                <td class="text-end" id="purchaseSubTotal" >0.00</td>
                                <td class="text-end" ></td>
                            </tr>
                            <tr>
                                <td colspan="8" class="font-weight-semibold text-end">Discount</td>
                                <td class="text-end" id="purchaseDiscount">0.00</td>
                                <td class="text-end"></td>
                            </tr>
                            <tr>
                                <td colspan="8" class="font-weight-semibold text-end">Cost</td>
                                <td class="text-end" id="purchaseCost">0.00</td>
                                <td class="text-end"></td>
                            </tr>
                            <tr class="text-danger">
                                <td colspan="8" class="font-weight-bold text-uppercase text-end h4 mb-0">Total Due</td>
                                <td class="font-weight-bold text-end h4 mb-0" id="purchaseTotal">0.00</td>
                                <td class="text-end"></td>
                            </tr>
                            <tr>
                                <td colspan="10" class="text-end">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="btnPrintInvoice"><i class="si si-printer"></i> Print</button>
...
<script src="<?php echo e(asset('assets/js/wip-parts-receive/view.js?v=1.0.1')); ?>"></script>

<!-- INTERNAL tooltip js-->
<!-- <script src="<?php echo e(asset('assets/js/tooltip.js')); ?>"></script> -->

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/wip-parts-receive/view.blade.php ENDPATH**/ ?>