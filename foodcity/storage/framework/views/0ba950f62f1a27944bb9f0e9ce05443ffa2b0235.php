                    ...
                    <table class="table table-bordered table-hover text-nowrap">
                        <tbody>
                            <tr class=" ">
                                ...
                                <th class="text-end" >Received Info</th>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><?php echo e($product->receive_date); ?><br><small>Received By: <?php echo e($product->user->first_name); ?> <?php echo e($product->user->last_name); ?></small></td>
                                <td class="text-end"><?php echo e($product->note); ?></td>
...
<!-- End row-->
<?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/wip-parts-receive/quickView.blade.php ENDPATH**/ ?>