            ...
            <form id="userCreateForm">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">UserNames<span class="text-red">*</span></label>
...
<script src="<?php echo e(asset('assets/superadmin/js/admins/create.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/superadmin/admins/create.blade.php ENDPATH**/ ?>