	...
	<body class="app">
		...
		<div class="page">
			<div class="page-main">
                ...
                <?php echo $__env->make('layouts.horizontal.app-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <?php echo $__env->make('layouts.horizontal.horizontal-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('layouts.horizontal.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    </body>
</html>
<?php /**PATH C:\xampp\htdocs\foodcity\resources\views/layouts/versions/horizontal-light.blade.php ENDPATH**/ ?>