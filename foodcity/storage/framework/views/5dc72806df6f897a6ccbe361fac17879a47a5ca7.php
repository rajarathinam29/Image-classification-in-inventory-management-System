	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('suppliers.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			...
			<div class="card-body" id="contentBody" style="display:none;">
				<div class="">
					<div class="table-responsive">
						<table id="suppliersTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
									<!-- <th class="border-bottom-0">User id</th> -->
									<th class="border-bottom-0">#</th>
									<th class="border-bottom-0">CompanyName</th>
                                    <th class="border-bottom-0">DealerName</th>
...
<script src="<?php echo e(asset('assets/js/suppliers/supplier.js?v=1.0.1')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/suppliers/supplier-list.blade.php ENDPATH**/ ?>