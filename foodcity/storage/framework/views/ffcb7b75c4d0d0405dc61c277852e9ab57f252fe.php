        ...
        <div class="card">
            <form id="permissionForm">
                ...
                <div class="card-footer text-end">
                    ...
                    <button type="submit" class="btn btn-success" id="btnSubmit">Set permission <i class="fe fe-skip-forward"></i></button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo e(asset('assets/js/usercompanies/setpermission.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/usercompanies/setpermission.blade.php ENDPATH**/ ?>