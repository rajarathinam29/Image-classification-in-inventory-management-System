...
<html lang="en" dir="ltr">
	<head>
        ...
        <?php echo $__env->make('layouts.custom-styles', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<?php echo $__env->yieldContent('class'); ?>
        ...
        <?php echo $__env->make('layouts.custom-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

	</div>

	</body>
</html>
<?php /**PATH C:\xampp\htdocs\foodcity\resources\views/layouts/versions/custom-light.blade.php ENDPATH**/ ?>