	...
	<div class="col-12">
						...
						<div class="col-lg-3 col-md-6">
							<div class="form-group">
								...
								<select class="form-control custom-select select2" name="sltStatus" id="sltStatus">
									...
									<option value="3">Completely Received</option>
		...
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('purchases.purchaseOrderCreate')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
						...
						<table id="purchaseOrderTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
									...
									<th class="border-bottom-0">wip Id</th>
...
<script src="<?php echo e(asset('assets/js/purchase/purchaseOrder.js?v=1.0.2')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/purchase/purchase-order.blade.php ENDPATH**/ ?>