            ...
            <form id="partsReceiveForm">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Bill No<span class="text-red">*</span></label>
                                <input type="text" class="form-control" name="invoice_no" id="invoice_no" placeholder="Bill No" autocomplete="off">  
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
...
<script src="<?php echo e(asset('assets/js/wip-parts-receive/create.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/wip-parts-receive/create.blade.php ENDPATH**/ ?>