	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('products.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
...
<script src="<?php echo e(asset('assets/js/products/product.js?v=1.0.2')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/products/product-list.blade.php ENDPATH**/ ?>