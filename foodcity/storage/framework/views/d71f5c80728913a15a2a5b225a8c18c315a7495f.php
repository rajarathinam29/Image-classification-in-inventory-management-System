            ...
            <form id="productcompaniesForm">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                <label class="form-label">Manufacture Status<span class="text-red">*</span></label>
...
<script src="<?php echo e(asset('assets/js/productcompanies/create.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/productcompanies/create.blade.php ENDPATH**/ ?>