	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('customers.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			...
			<div class="card-body" id="contentBody" style="display:none;">
				<div class="">
					<div class="table-responsive">
						<table id="customersTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							<thead>
								<tr>
									...
									<th class="border-bottom-0">Pay Term</th>
...
<script src="<?php echo e(asset('assets/js/customers/customer.js?v=1.0.2')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/customers/customer-list.blade.php ENDPATH**/ ?>