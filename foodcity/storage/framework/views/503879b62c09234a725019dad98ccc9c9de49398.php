...
<div class="page-header">
	<div class="page-leftheader">
		...
		<p class="mb-0 text-primary" id="pChequeStatus"><?php echo e($title); ?> </p>
	</div>
</div>
<!--End Page header-->
...
<script src="<?php echo e(asset('assets/js/cheque/received/cheque-list.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/cheque/received/cheque-list.blade.php ENDPATH**/ ?>