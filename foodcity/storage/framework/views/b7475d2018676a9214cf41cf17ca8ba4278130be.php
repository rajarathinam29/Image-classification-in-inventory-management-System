	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('stockTransfer.create')); ?>" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
					<div class="table-responsive">
						<table id="stocktransferTbl" class="table table-sm table-bordered text-nowrap key-buttons">
							...
							<tbody id="stocktransferContent"></tbody>
						</table>
					</div>
				</div>
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\foodcity\resources\views/admin/stock/stocktransfer-list.blade.php ENDPATH**/ ?>