                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-4" name="description" id="description" placeholder="Description" rows="3"></textarea>
                                </div>
                            </div>
                    </div>
                </div>
...
<script src="{{asset('assets/js/productcompanies/create.js')}}"></script>
