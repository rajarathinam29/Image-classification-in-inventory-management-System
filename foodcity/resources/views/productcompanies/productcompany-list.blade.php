	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="{{route('productcompanies.create')}}" class="btn btn-md btn-green"><i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
...
<script src="{{asset('assets/js/productcompanies/productcompany.js')}}"></script>
