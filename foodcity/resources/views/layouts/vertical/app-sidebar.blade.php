				...
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="{{route('adminDashboard')}}">
							...
							<img src="{{asset('assets/images/brand/foodcitylogo.png')}}" class="header-brand-img dark-logo" alt="Azea logo">
							<img src="{{asset('assets/images/brand/foodcitylogo.png')}}" class="header-brand-img mobile-logo" alt="Azea logo">
							<img src="{{asset('assets/images/brand/foodcitylogo.png')}}" class="header-brand-img darkmobile-logo" alt="Azea logo">
						</a>
					</div>
					<ul class="side-menu app-sidebar3" id="appSidebar">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="liproductsView"><a href="{{route('products')}}" class="slide-item "> Product List</a></li>
								<li class="liproductsView"><a href="{{route('products.imagesearch')}}" class="slide-item "> Search Image</a></li>
								<li class="liproductsView"><a href="{{route('productcategories')}}" class="slide-item "> Categories</a></li>
								<li class="liproductsView"><a href="{{route('productcompanies')}}" class="slide-item "> Manufactures</a></li>
								<li class="liproductsView"><a href="{{route('productbrands')}}" class="slide-item "> Brands</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="lisuppliersView"><a href="{{route('suppliers')}}" class="slide-item"> Supplier List</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="lipurchasesView"><a href="{{route('purchases')}}" class="slide-item"> Purchase List</a></li>
								<li class="lipurchasesView"><a href="{{route('purchases.purchaseOrder')}}" class="slide-item"> Purchase Order</a></li>
								<li class="lipurchase_paymentView"><a href="{{route('purchases.purchasepayments')}}" class="slide-item"> Purchase Payments</a></li>
								<li class="lipurchase_paymentWrite"><a href="{{route('payorder.create')}}" class="slide-item"> Pay order</a></li>
								<li class="lipurchase_returnView"><a href="{{route('purchaseReturn')}}" class="slide-item"> Purchase Return</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="licustomersView"><a href="{{route('customers')}}" class="slide-item"> Customer List</a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="lisalesWrite"><a href="{{route('sales.create')}}" class="slide-item"> New Sales</a></li>
								<li class="lisalesView"><a href="{{route('sales')}}" class="slide-item"> Sales List</a></li>
								<li class="lisalesView"><a href="{{route('sales.returns')}}" class="slide-item"> Returns</a></li>
								<li class="lisales_paymentView"><a href="{{route('sales.salespayments')}}" class="slide-item"> Sales Payments</a></li>
								<li class="lisales_paymentWrite"><a href="{{route('collectcredit.create')}}" class="slide-item"> Collect Credit</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="listockView"><a href="{{route('stock')}}" class="slide-item"> Stock</a></li>
								<li class="listock_transferView"><a href="{{route('stockTransfer')}}" class="slide-item"> Stock Transfers</a></li>
								<li class="listock_countView"><a href="{{route('stockcount')}}" class="slide-item"> Stock Count</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="liexpensesView"><a href="{{route('expenses')}}" class="slide-item"> Expenses List</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="lirevenuesView"><a href="{{route('revenues')}}" class="slide-item"> Revenue List</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="livouchersWrite"><a href="{{route('vouchers.sale')}}" class="slide-item"> Voucher Sale</a></li>
								<li class="livouchersView"><a href="{{route('vouchers.saleslists')}}" class="slide-item"> Voucher Sales List</a></li>
								<li class="livouchersView"><a href="{{route('vouchers')}}" class="slide-item"> Gift Vouchers</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="lichequesView"><a href="{{route('chequeissued')}}" class="slide-item"> Cheque Issued</a></li>
								<li class="lichequesView"><a href="{{route('chequereceived')}}" class="slide-item"> Cheque Received</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li class="lireportsStockReport"><a href="{{route('reports.stockReport')}}" class="slide-item"> Stock Report</a></li>
								<li class="lireportsFrequentlySales"><a href="{{route('reports.frequentlysales-report')}}" class="slide-item"> Frequently Sales Report</a></li>
								<li class="lireportsFrequentlyPurchase"><a href="{{route('reports.frequentlypurchase-report')}}" class="slide-item"> Frequently Purchase Report</a></li>
								<li class="lireportsSalesSummaryReport"><a href="{{route('reports.salessummary-report')}}" class="slide-item"> Sales Summary Report</a></li>
								<li class="lireportsSalesSummaryReport"><a href="{{route('reports.profit-report')}}" class="slide-item"> Profit Report</a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="lilogsView"><a href="{{route('logs')}}" class="slide-item">Logs</a></li> 
							</ul>
						</li>
