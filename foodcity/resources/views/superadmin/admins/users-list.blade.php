	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="{{route('superAdminAdmins.create')}}" class="btn btn-md btn-green"><i class="fa fa-user-plus"></i></a>
			</div>
			<div class="card-body">
				<div class="">
...
<script src="{{asset('assets/superadmin/js/admins/users.js')}}"></script>
