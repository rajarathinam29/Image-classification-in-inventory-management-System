	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<div class="btn-list">
					<button class="btn btn-warning" id="btnUnchecked">UnChecked</button>
					<button class="btn btn-success" id="btnAllReturn">All Returns</button>
				</div>
			</div>
			<div class="card-body">
				<div class="">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3">Damage Note</h5>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-label">Leave Note</label>
							<textarea class="form-control mb-4" placeholder="Leave Note" rows="3" id="inputDamageNote"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnAddDamage"><i class="fe fe-plus"></i> Add</button>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('assets/js/sales/returns.js')}}"></script>
