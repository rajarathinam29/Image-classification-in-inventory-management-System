...
<link rel="stylesheet" href="{{asset('assets/plugins/datatables/FixedHeader/css/fixedHeader.dataTables.css')}}">
<!-- Data table css -->
...
<!-- fixed Column  -->
<!-- <link rel="stylesheet" href="{{asset('assets/plugins/datatables/FixedColumns/css/fixedColumns.dataTables.css')}}"> -->
<link rel="stylesheet" href="{{asset('assets/plugins/datatables/FixedColumns/css/fixedColumns.bootstrap5.min.css')}}">
			...
			<div class="row me-0 ms-0">
				<div class="col-xl-3 col-lg-6 col-sm-6 pe-0 ps-0 border-end">
					<div class="card-body text-center">
						...
						<h2 class="mb-1 font-weight-bold" id="stockValCost">0</h2>
				...
				<div class="col-xl-3 col-lg-6 col-sm-6 pe-0 ps-0 border-end">
					<div class="card-body text-center">
						...
						<h2 class="mb-1 font-weight-bold" id="stockValSell">0</h2>
				...
				<div class="col-xl-3 col-lg-6 col-sm-6 pe-0 ps-0 border-end">
					<div class="card-body text-center">
						...
						<h2 class="mb-1 font-weight-bold" id="stockValProfit">0</h2>
				...
				<div class="col-xl-3 col-lg-6 col-sm-6 pe-0 ps-0">
					<div class="card-body text-center">
						...
						<h2 class="mb-1 font-weight-bold" id="stockValMargin">0</h2>
...
<!-- <script src="{{asset('assets/plugins/datatables/DataTables/js/dataTables.dataTables.js')}}"></script> -->
...
<scritp src="{{asset('assets/plugins/datatables/FixedHeader/js/dataTables.fixedHeader.js')}}"></script>

<scritp src="{{asset('assets/plugins/datatables/FixedColumns/js/dataTables.fixedColumns.js')}}"></script>
<scritp src="{{asset('assets/plugins/datatables/FixedColumns/js/fixedColumns.bootstrap5.min.js')}}"></script>

<!-- <script src="{{asset('assets/js/datatables.js')}}"></script> -->


<script src="{{asset('assets/js/stock/stock.js?v=1.0.3')}}"></script>
