			...
			<div class="card">
				<div class="card-header">
					...
					<div class="card-options">
						<a href="{{route('logs')}}" class="btn btn-sm btn-primary">View All</a>
					</div>
				</div>
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-6">
			<div class="card">
				<div class="card-header">
					...
					<div class="card-options">
						<a href="{{route('reports.frequentlysales-report')}}" class="btn btn-sm btn-primary">View All</a>
					</div>
				</div>
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-6">
			<div class="card">
				<div class="card-header">
					...
					<div class="card-options">
						<a href="{{route('reports.frequentlypurchase-report')}}" class="btn btn-sm btn-primary">View All</a>
					</div>
				</div>
				<div class="card-body p-0">
					<div class="table-responsive">
...
@section('scripts')
		...
		<script src="{{asset('assets/js/dashboard/dashboard.js?v=1.0.4')}}"></script>
