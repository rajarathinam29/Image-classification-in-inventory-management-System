		...
		<div class="card">
			<div class="card-header">
				...
				<div class="card-options">
					<a href="{{url('uploads/import/suppliers.xlsx')}}" class="btn btn-sm btn-success" target="_blank"><i class="fe fe-download me-2"></i> Download Templete File</a>
				</div>
			</div>
			<div class="card-body">
...
<script src="{{asset('assets/js/settings/imports/importSuppliers.js?v=1.0.1')}}"></script>
