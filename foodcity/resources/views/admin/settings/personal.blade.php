        ...
        <div class="col-lg-12 col-xl-8">
            <div class="box-widget widget-user">
                <div class="widget-user-image1 d-xl-flex d-block">
                    <img alt="User Avatar" class="avatar brround p-0" src="{{asset('assets/images/users/2.jpg')}}" id="userAvatar">
...
<script src="{{asset('assets/js/settings/general/personal.js')}}"></script>
