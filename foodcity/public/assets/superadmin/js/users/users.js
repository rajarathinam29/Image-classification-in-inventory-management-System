...
$(function(){
    ...
    $(document).on('click', '.btnView', function(){
        ...
        var data = {userId:usersData[k].id};
        location.assign(`${baseUrl}/superAdmin/users/view?q=${btoa(JSON.stringify(data))}`);
    });
    // Edit user
    ...
    $(document).on('click', '.btnDelete', function(){
        ...
        swal({
            ...
            if (result) {
                let data = adminData;
                data.userId = usersData[k].id;
                console.log(data);
                $.ajax({
                    url: baseUrl+"/superAdmin/users/deleteuser",
                    type: "POST",
                    data: data,
    ...
    function getUsers(){
        ...
        let data = adminData;
        $.ajax({
            url: `${baseUrl}/superAdmin/users/getUsers`,
            type: "POST",
            dataType: "json",
            data: data,
            success: function(result){
